            ...
            <ul>
                <?php foreach ($minijuegos as $juego): ?>
                    <li>
                        ...
                        <?php
                            //obtinee el nombre del minijuego desde un array
                            $minijuego = ($juego['minijuego']);
                            //Guarda el nombre del minijuego en una cookie llamada "ultimo_minijuego"
                            setcookie("ultimo_minijuego", $minijuego);
                        ?>

                        <a href="datos.php?minijuego=<?= $minijuego ?>">Ver detalles</a>
